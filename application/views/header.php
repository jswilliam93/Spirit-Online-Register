      ...
      <ul class="header-menu nav navbar-nav">
        ...
        <!-- <li class="dropdown" id="language-header">
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <a href="#" data-lang="es"><img src="<?php echo base_url();?>assets/images/flags/Egypt.png" alt="flag-english"> <span>Arabic</span></a>
            </li>
          </ul>
        </li> -->
        <!-- END USER DROPDOWN -->
              ...
              <ul class="dropdown-menu-list withScroll" data-height="220">
                <li class="clearfix">
                  <span class="pull-left p-r-5">
                    <img src="<?php echo base_url();?>assets/images/avatars/avatar3.png" alt="avatar 3">
                  </span>
                  <div class="clearfix">
                    <div>
        ...
        <li class="dropdown" id="user-header">
          <a href="#" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
            <span class="username font-blue"><?php echo $me[0]->name ?></span>
          </a>
        </li>
        <!-- END USER DROPDOWN -->
        <!-- CHAT BAR ICON -->
